...
describe Pubnub::ManageMemberships do
  ...
  context "given basic parameters" do
    ...
    it "get_members_works", :focus => true do
    ...
    it "get_space_memberships_works", :focus => true do
    ...
    it "manage_memberships_add_works", :focus => true do
    ...
    it "manage_memberships_remove_works", :focus => true do
    ...
    it "manage_members_add_works", :focus => true do
    ...
    it "manage_members_remove_works", :focus => true do
