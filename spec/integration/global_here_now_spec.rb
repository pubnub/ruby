    ...
    context "passess callback as block" do
      context "gets valid json in response" do
        context "gets status 200 in response" do
          context "uses sync connection" do
            it 'works fine' do
              VCR.use_cassette("integration/here_now/here_now_global-ssl-block-valid-200-sync", :record => :none) do
        ...
        context "gets status non-200 in response" do
          context "uses sync connection" do
            it 'works fine' do
              VCR.use_cassette("integration/here_now/here_now_global-ssl-block-valid-non-200-sync", :record => :none) do
                @pn.here_now(:ssl => true, :http_sync => true, :channel => "demo", :callback => @callback)
      ...
      context "gets invalid json in response" do
        context "gets status 200 in response" do
          context "uses sync connection" do
            it 'works fine' do
              VCR.use_cassette("integration/here_now/here_now_global-ssl-block-invalid-200-sync", :record => :none) do
                @pn.here_now(:ssl => true, :http_sync => true, :channel => "demo", :callback => @callback)
        ...
        context "gets status non-200 in response" do
          context "uses sync connection" do
            it 'works fine' do
              VCR.use_cassette("integration/here_now/here_now_global-ssl-block-invalid-non-200-sync", :record => :none) do
                @pn.here_now(:ssl => true, :http_sync => true, :channel => "demo", :callback => @callback)
    ...
    context "passess callback as block" do
      context "gets valid json in response" do
        context "gets status 200 in response" do
          context "uses sync connection" do
            it 'works fine' do
              VCR.use_cassette("integration/here_now/here_now_global-nonssl-block-valid-200-sync", :record => :none) do
        ...
        context "gets status non-200 in response" do
          context "uses sync connection" do
            it 'works fine' do
              VCR.use_cassette("integration/here_now/here_now_global-nonssl-block-valid-non-200-sync", :record => :none) do
                @pn.here_now(:http_sync => true, :channel => "demo", :callback => @callback)
      ...
      context "gets invalid json in response" do
        context "gets status 200 in response" do
          context "uses sync connection" do
            it 'works fine' do
              VCR.use_cassette("integration/here_now/here_now_global-nonssl-block-invalid-200-sync", :record => :none) do
                @pn.here_now(:http_sync => true, :channel => "demo", :callback => @callback)
        ...
        context "gets status non-200 in response" do
          context "uses sync connection" do
            it 'works fine' do
              VCR.use_cassette("integration/here_now/here_now_global-nonssl-block-invalid-non-200-sync", :record => :none) do
                @pn.here_now(:http_sync => true, :channel => "demo", :callback => @callback)
